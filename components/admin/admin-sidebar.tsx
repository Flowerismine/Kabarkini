...
const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { label: 'Review Queue', href: '/admin/review', icon: Eye, badge: '3' },
  ...
  return (
    <aside className="w-60 shrink-0 bg-[var(--navy)] min-h-screen flex flex-col">
                ...
                return (
                  <li key={item.href}>
                    ...
                    >
                      ...
                      {item.badge && (
                        <span className="bg-[var(--red)] text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full leading-none">
                          {item.badge}
                        </span>
                      )}
                    </Link>
      ...
      <div className="border-t border-white/10 px-3 py-4 space-y-1">
        ...
        <Link
          href="/admin"
          className="admin-nav-link text-xs text-slate-600"
        >
